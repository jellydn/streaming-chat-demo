...
![Prerequisite](https://img.shields.io/badge/node-LTS-blue.svg)
...
| Command                | Description                                      |
| ---------------------- | ------------------------------------------------ |
| `bun run dev`          | Start client (Vite) + server (Hono) concurrently |
| `bun run build`        | TypeScript check + Vite production build         |
| `bun run typecheck`    | TypeScript type-check only                       |
| `bun run lint`         | Lint with oxlint (`src server`)                  |
